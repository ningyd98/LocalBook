export const enUS = {
  ...
  settings: {
    ...
    fontFamily: "Font",
    fontFamilyHelp: "Typeface used by the interface and your notes",
    fontTarget: "Applies to",
    fontTargetAll: "Whole interface",
    fontTargetNote: "Note body only",
    fontScale: "Text size",
    fontScaleHelp: "Scale the whole interface and notes (80%–160%)",
    fontScaleReset: "Reset to default",
    fontSans: "Sans-serif",
    fontSerif: "Serif",
    fontMono: "Monospace",
    fontRounded: "Rounded",
